    ...
    public void onBindViewHolder(@NonNull final ContactoViewHolder contactoViewHolder, int posicion) {
            ...
            contactoViewHolder.imgbCorreo.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    mailIntent.putExtra(Intent.EXTRA_SUBJECT,R.string.mensajecontacto);
                    mailIntent.putExtra(Intent.EXTRA_TEXT,R.string.mensajeenviado);
                    try {
                        activity.startActivity(Intent.createChooser(mailIntent,"Enviando"));
                        activity.finish();
                        Log.i("Finaliza envío","Proceso de envío");
                    }
